...
import { CrearTipoHabitacionComponent } from '../../components/tipo-habitacion/crear-tipo-habitacion/crear-tipo-habitacion.component';

@Component({
  selector: 'app-tipo-habitacion',
  imports: [
    MatButtonModule,
    BotonesPrincipalesComponent,
    MatTableModule,
    MatPaginatorModule,
  ],
...
export default class TipoHabitacionComponent implements AfterViewInit {
